function cookie(e, o, i) {
  ...
  i.expires &&
    ...
    ("number" == typeof i.expires
      ? (s = new Date()).setTime(s.getTime() + 24 * i.expires * 60 * 60 * 1e3)
      : (s = i.expires),
...
document.getElementById("phone").addEventListener("blur", function (e) {
  ...
  if (value.length !== 11) {
    errorNote.textContent =
      "Введите корректный номер телефона (+7 999 999 99 99)";
